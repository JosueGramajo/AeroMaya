									...
									<div class="container">
										<table id="reportTable" class="table table-striped">
											...
											<tr>
												...
												<th scope="col">Cantidad de tickets comprados</th>
											...
											<tbody>
												<c:forEach items="${report}" var="item">
													<tr>
														...
														<td>${item.name}</td>
														<td>${item.email}</td>
														<td>${item.amountBuys}</td>
														<td>${item.totalSpent}</td>
														<td><button class="btn btn-info userBuys" data-id="${item.id}" data-email="${item.email}">Ver compras</button></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
...
<script src="../../assets/js/admin/reporUser.js"></script>
